...
interface DashboardDemoMapLayerState {
...
export const useDashboardDemoMapLayerStore = create<DashboardDemoMapLayerState>()(
  persist(
    (set) => ({
      visibility: {
        poi: true,
    ...
    {
      name: 'dashboard-demo-map-layer-store-v1',
    }
  )
);
