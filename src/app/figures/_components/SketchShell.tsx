...
export function SketchShell({ title, subtitle, eyebrow = 'Figures', children }: SketchShellProps) {
  return (
...
export function SketchPanel({ title, subtitle, className = '', children }: SketchPanelProps) {
  return (
    <section className={`rounded-[1.5rem] border border-neutral-300 bg-white shadow-[0_1px_0_rgba(0,0,0,0.02)] ${className}`}>
