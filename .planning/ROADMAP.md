...
**Plans**: 3
Plans:
- `.planning/phases/01-overview-pattern-summaries/01-PLAN.md` — Reframe the dashboard shell and status rail around overview-first semantics.
...
|-------|--------------|--------|-----------|
| 1. Overview + pattern summaries | 4 | Not started | - |
