...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 66-01-01 | 01 | 1 | FLOW-01, FLOW-02 | integration | `pnpm vitest src/app/dashboard-v2/page.stkde.test.ts --run` | ✅ | ⬜ pending |
| 66-01-02 | 01 | 1 | FLOW-03, FLOW-05 | unit/integration | `pnpm vitest src/store/useCoordinationStore.test.ts src/store/useStkdeStore.test.ts --run` | ✅ | ⬜ pending |
| 66-01-03 | 01 | 1 | FLOW-01..FLOW-05 | type + suite | `pnpm -s tsc --noEmit && pnpm vitest --run` | ✅ | ⬜ pending |
