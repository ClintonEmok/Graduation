...
<task type="auto">
  ...
  <action>
    ...
    3. (Optional) Add a temporary test button or effect to verify Toaster works (remove before finishing if verified manually).
    4. Ensure `Toaster` is positioned correctly (usually bottom-right or top-right).
  </action>
  <verify>
