...
<task type="auto">
  ...
  <action>
    ...
    This replaces the need for a binary toggle, supporting a continuous blend factor (0 = Linear, 1 = Full Adaptive).
  </action>
  <verify>
...
<task type="auto">
  ...
  <verify>
    ...
    Run round-trip test: `toLinear(toAdaptive(t)) ≈ t` with `warpFactor = 0.5`.
  </verify>
  <done>
