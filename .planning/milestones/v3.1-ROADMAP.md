...
- ✅ **v3.1 Workflow Finalization** — Completed 2026-05-26
...
Plans:
- [x] 73-01-PLAN.md — Make Inspect open with immediate active-slice context and inline comparison controls
...
Plans:
- [x] 74-01-PLAN.md — Bridge active slice sync across views, guard refetch override, filter map by slice
...
Plans:
- [x] 75-01-PLAN.md — Replace presentation language ('Showcase', 'Catalyst cue'), simplify comparison labels, fix confusing copy
